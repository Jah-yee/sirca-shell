...
ContainmentItem {
    ...
    // --- Sirca Shell hooks ---
    readonly property Item glassExpandedItem: expandedRepresentation
    readonly property bool glassExpanded: systemTrayState.expanded
    function glassCollapse() { systemTrayState.expanded = false }
    function glassExpand() { systemTrayState.expanded = true }
    ...
    MouseArea {
        ...
        PlasmaCore.AppletPopup {
            ...
            visible: false   // Sirca Shell: no popup window; the bar adopts expandedRepresentation into its "tray" lobe
